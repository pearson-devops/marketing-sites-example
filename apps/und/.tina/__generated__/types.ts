...
export type PagesBlocksTest = {
  __typename?: 'PagesBlocksTest';
  text?: Maybe<Scalars['JSON']>;
};

export type PagesBlocks = PagesBlocksHero | PagesBlocksFeatures | PagesBlocksContent | PagesBlocksTestimonial | PagesBlocksTest;
...
export type PagesBlocksTestMutation = {
  text?: InputMaybe<Scalars['JSON']>;
};
...
export type PagesBlocksMutation = {
  ...
  test?: InputMaybe<PagesBlocksTestMutation>;
};
